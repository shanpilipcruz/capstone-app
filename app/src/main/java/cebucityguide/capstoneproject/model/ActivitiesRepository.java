...
public class ActivitiesRepository {
    ...
    private List<cebucityguide.capstoneproject.model.ActivitiesCollection> collections;
    ...
    private ActivitiesRepository(Context context) {
        ...
        // Build collection
        cebucityguide.capstoneproject.model.ActivitiesCollection activity = buildActivityCollection();
        collections.add(activity);

        cebucityguide.capstoneproject.model.ActivitiesCollection restaurants = buildRestaurantsCollection();
        collections.add(restaurants);

        cebucityguide.capstoneproject.model.ActivitiesCollection breweries = buildBreweriesCollection();
        collections.add(breweries);

        cebucityguide.capstoneproject.model.ActivitiesCollection nightLife = buildNightLifeCollection();
    ...
    @VisibleForTesting
    static cebucityguide.capstoneproject.model.ActivitiesCollection buildActivityCollection() {
        List<cebucityguide.capstoneproject.model.Activities> attractions = new ArrayList<>();

        attractions.add(new cebucityguide.capstoneproject.model.Activities(
        ...
        return new cebucityguide.capstoneproject.model.ActivitiesCollection(R.string.top_activities, attractions);
    }

    @VisibleForTesting
    static cebucityguide.capstoneproject.model.ActivitiesCollection buildRestaurantsCollection() {
        ArrayList<cebucityguide.capstoneproject.model.Activities> attractions = new ArrayList<>();
        ...
        return new cebucityguide.capstoneproject.model.ActivitiesCollection(R.string.top_restaurants, attractions);
    }

    @VisibleForTesting
    static cebucityguide.capstoneproject.model.ActivitiesCollection buildBreweriesCollection() {
        ArrayList<cebucityguide.capstoneproject.model.Activities> attractions = new ArrayList<>();
        ...
        return new cebucityguide.capstoneproject.model.ActivitiesCollection(R.string.top_places, attractions);
    }

    @VisibleForTesting
    static cebucityguide.capstoneproject.model.ActivitiesCollection buildNightLifeCollection() {
        ArrayList<cebucityguide.capstoneproject.model.Activities> attractions = new ArrayList<>();
        ...
        return new cebucityguide.capstoneproject.model.ActivitiesCollection(R.string.top_bars_nightlife, attractions);
    }

    public cebucityguide.capstoneproject.model.ActivitiesCollection getCollection(int sectionTitle) {
    ...
    public List<cebucityguide.capstoneproject.model.ActivitiesCollection> getCollections() {
        return collections;
    }
}
