...
import cebucityguide.capstoneproject.ActivitiesActivity_ListActivity;
import cebucityguide.capstoneproject.R;
import cebucityguide.capstoneproject.SingleActivityDataAdapter;
import cebucityguide.capstoneproject.Utils;
...
public class MasterAdapter extends RecyclerView.Adapter<MasterAdapter.SectionViewHolder> {
    ...
    public void onBindViewHolder(@NonNull SectionViewHolder holder, final int position) {
        ...
        final List<Activities> activities = currentCollection.getAttractions();

        SingleActivityDataAdapter singleActivityAdapter = new SingleActivityDataAdapter(mContext, activities);
